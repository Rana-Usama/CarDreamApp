      ...
      >
        ...
        >
          <ScrollView
            ...
            style={{ paddingLeft: RFPercentage(2), paddingRight: RFPercentage(2) }}
          >
            {selectedImages.length === 0 && imageLoading ? (
              <View
                style={{
              ...
              >
                <LoadingIndicator show={imageLoading} />
              </View>
            ) : null}
        ...
        >
          ...
          <Image
            style={{ width: RFPercentage(3), height: RFPercentage(3), marginLeft: RFPercentage(1) }}
            source={require('../../assets/Images/insert.png')}
          />
        </View>
        ...
        >
          <View
            style={{ width: '100%', paddingLeft: RFPercentage(2), paddingTop: RFPercentage(1) }}
          >
            <TextInput
              multiline={true}
        ...
        >
          <ScrollView
            horizontal
            showsHorizontalScrollIndicator={false}
            contentContainerStyle={{ paddingLeft: RFPercentage(1.6) }}
          >
        ...
        >
          ...
          >
            {features ? (
              ...
              <Image
                style={{ width: RFPercentage(2.8), height: RFPercentage(2.8) }}
                source={require('../../assets/Images/addf.png')}
              />
            )}
            <Text
              style={{
          ...
          <View style={{ width: '90%', marginTop: RFPercentage(2) }}>
            ...
            {allFeatures.map((feature, index) => (
              <TouchableOpacity
                activeOpacity={0.8}
                key={index}
                onPress={() => toggleFeatureSelection(feature)}
                style={{ flexDirection: 'row', alignItems: 'center', marginTop: RFPercentage(1) }}
              >
                <View
                  style={{
