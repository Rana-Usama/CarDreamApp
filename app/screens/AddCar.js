...
function AddCar({ navigation }) {
  ...
  const [inputField, SetInputField] = useState([
    ...
    {
      placeholder: "Engine Capacity e.g. 3000cc",
      value: "",
    },
    {
    ...
    {
      placeholder: "KM Driven e.g. 100000KM",
      value: "",
    },
    {
  ...
  return (
    <Screen style={styles.screen}>
      <ScrollView style={{ width: "100%" }} contentContainerStyle={{ width: "100%", alignItems: "center" }} stickyHeaderIndices={[0]}>
        ...
        >
          <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.goBack()} style={{ position: "absolute", left: 0, justifyContent: "center", alignItems: "flex-start" }}>
            <Ionicons name="chevron-back" style={{ fontSize: RFPercentage(3) }} color={Colors.black} />
          </TouchableOpacity>
          <Text style={{ alignSelf: "center", color: Colors.black, fontSize: RFPercentage(2.2), fontFamily: "Poppins_500Medium" }}>Sell Your Car</Text>

          <TouchableOpacity activeOpacity={0.8} style={{ position: "absolute", right: 0 }}>
            <Text style={{ color: Colors.primary, fontSize: RFPercentage(1.8), fontFamily: "Poppins_500Medium" }}>Done</Text>
          </TouchableOpacity>
        </View>
        ...
        >
          ...
          <Text style={{ fontSize: RFPercentage(1.7), marginTop: RFPercentage(0.6), color: Colors.primary, fontFamily: "Poppins_400Regular" }}>Add Photos</Text>
        </TouchableOpacity>

        {/* Picked Images */}
        <View style={{ width: "100%", justifyContent: "flex-start", alignItems: "center", marginTop: RFPercentage(2), alignSelf: "center", flexDirection: "row" }}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ paddingLeft: RFPercentage(2), paddingRight: RFPercentage(2) }}>
            {selectedImages.map((imageUri, index) => (
              <ImageBackground
                key={index}
                style={{ marginLeft: RFPercentage(1), width: RFPercentage(12), height: RFPercentage(12), borderRadius: RFPercentage(1), overflow: "hidden" }}
                source={{ uri: imageUri }}
              >
                <TouchableOpacity
                  activeOpacity={0.8}
                  onPress={() => removeImage(index)}
                  style={{ position: "absolute", right: RFPercentage(0.1), top: RFPercentage(0.1), justifyContent: "center", alignItems: "flex-start" }}
                >
        ...
        {/* Input details */}
        <View style={{ width: "90%", flexDirection: "row", justifyContent: "flex-start", alignItems: "center", alignSelf: "center", marginTop: RFPercentage(2) }}>
          <Text style={{ color: Colors.darkGrey2, fontSize: RFPercentage(2), fontFamily: "Poppins_500Medium" }}>Input Car Details</Text>
        ...
        {/* seller comments */}
        <View style={{ marginTop: RFPercentage(2), width: "90%", height: RFPercentage(20), borderRadius: RFPercentage(1.6), borderColor: Colors.lightGrey, borderWidth: RFPercentage(0.1) }}>
          <View style={{ width: "100%", paddingLeft: RFPercentage(2), paddingTop: RFPercentage(1) }}>
            <TextInput multiline={true} placeholder="Comments" />
          </View>
        </View>
        ...
        <DropDownPicker
          ...
          dropDownContainerStyle={{ marginTop: RFPercentage(2), width: "90%", alignSelf: "center", borderColor: Colors.lightGrey, borderWidth: RFPercentage(0.1) }}
          open={open}
        ...
        {/* Select State */}
        <View style={{ width: "89%", flexDirection: "row", justifyContent: "flex-start", alignItems: "center", alignSelf: "center", marginTop: RFPercentage(3) }}>
        ...
        <View style={{ marginTop: RFPercentage(1.6), width: "100%", justifyContent: "flex-start", alignItems: "center", flexDirection: "row" }}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingLeft: RFPercentage(1.6) }}>
            {governorateStates.map((state, index) => (
              ...
              >
                <Text style={{ color: Colors.black, fontSize: RFPercentage(1.7), fontFamily: "Poppins_400Regular" }}>{state}</Text>
              </TouchableOpacity>
            ))}
          </ScrollView>
        </View>
        ...
        {/* Car Type */}
        <View style={{ width: "89%", flexDirection: "row", justifyContent: "flex-start", alignItems: "center", alignSelf: "center", marginTop: RFPercentage(2.5) }}>
          <Text style={{ color: Colors.grey, fontSize: RFPercentage(1.8), fontFamily: "Poppins_400Regular" }}>
        ...
        <View style={{ marginTop: RFPercentage(1.6), width: "100%", justifyContent: "flex-start", alignItems: "center", flexDirection: "row" }}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingLeft: RFPercentage(1.6) }}>
            {carTypes.map((type, index) => (
              ...
              >
                <Text style={{ color: Colors.black, fontSize: RFPercentage(1.7), fontFamily: "Poppins_400Regular" }}>{type}</Text>
              </TouchableOpacity>
            ))}
          </ScrollView>
        </View>
        ...
        {/* Features */}
        <View style={{ width: "90%", flexDirection: "row", justifyContent: "flex-start", alignItems: "center", alignSelf: "center", marginTop: RFPercentage(3) }}>
          <TouchableOpacity onPress={() => toggleFeatures()} activeOpacity={0.8} style={{ flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
            ...
            <Text style={{ color: Colors.darkGrey2, fontSize: RFPercentage(2), fontFamily: "Poppins_500Medium", marginLeft: RFPercentage(1) }}>Features</Text>
          </TouchableOpacity>
        </View>
        {features ? (
          <View style={{ width: "90%", marginTop: RFPercentage(2) }}>
            <Text style={{ color: Colors.darkGrey2, fontSize: RFPercentage(1.8), fontFamily: "Poppins_500Medium" }}>Select Features:</Text>
            {allFeatures.map((feature, index) => (
              <TouchableOpacity activeOpacity={0.8} key={index} onPress={() => toggleFeatureSelection(feature)} style={{ flexDirection: "row", alignItems: "center", marginTop: RFPercentage(1) }}>
                ...
                >
                  {selectedFeatures.includes(feature) && <View style={{ width: RFPercentage(2), height: RFPercentage(2), borderRadius: RFPercentage(1), backgroundColor: Colors.primary }} />}
                </View>
                <Text style={{ marginLeft: RFPercentage(1), color: Colors.black, fontSize: RFPercentage(1.8), fontFamily: "Poppins_400Regular" }}>{feature}</Text>
              </TouchableOpacity>
            ))}
          </View>
        ) : null}
